...
const SUPPORTTED_IMAGE_TYPES = [
 ...
 const SYSTEM_PROMPTS = {
    image: "You turn images into text. If it is a photo of a document, transcribe it. If it is no a document, describe it.",
 ...
 export async function extractTextContent(
    ...
    assert(url, "Failed o get storage URL");

    if(SUPPORTTED_IMAGE_TYPES.some((type) => type === mimeType)) {
