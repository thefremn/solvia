...
(function() {
  ...
  if (!organizationId) {
    console.error('Solvia Widget: data-organization-id attribute is required');
    return;
  }
  ...
  function render() {
    ...
    button.id = 'solvia-widget-button';
    ...
    container.id = 'solvia-widget-container';
